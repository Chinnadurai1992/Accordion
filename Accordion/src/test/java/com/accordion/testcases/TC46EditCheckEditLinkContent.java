...
public class TC46EditCheckEditLinkContent extends loginURL
{
	int a;
	@Test(priority = 31)
	public void EditCheckEditLinkContentTC46() throws Exception
	{
		...
		{	
			...
			editTab.editlinkbtn(myelement);
			editTab.editlinkfields(myelement);
