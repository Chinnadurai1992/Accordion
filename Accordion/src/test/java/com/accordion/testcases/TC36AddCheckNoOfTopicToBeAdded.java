...
public class TC36AddCheckNoOfTopicToBeAdded extends loginURL
{
	int a;
	@Test(priority = 26)
	public void AddCheckNoOfTopicToBeAddedTC36() throws Exception
	{
//		addTab.addtab();
//		addTab.addNextbtn_TopicToAddNumber();
//		addTab.addScreenCount();
		...
		{	
			...
			addTab.addScreenCount(myelement);
